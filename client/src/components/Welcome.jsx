    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <p className="text-left mt-5 text-white font-light md:w9/12 w-10/12 text-base">
            Explore the crypto world. Buy and sell crypto across the world on
            KryptoX
          </p>
          {!currentAccount && (
            <button
             ...
             bg-[#2952e3] p-3 rounded-full cursor-pointer hober:bg-[#25463d]"
            >
